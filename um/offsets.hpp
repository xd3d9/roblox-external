...
namespace Offsets {
	...
	constexpr std::uint32_t RenderToDataModel = 0x118;
	constexpr std::uint32_t DataModelPtrToRealDataModel = 0x198;
	constexpr std::uint32_t Parent = 0x60;
	constexpr std::uint32_t Primitive = 0x150;
	constexpr std::uint32_t ClassDescriptor = 0x18;
	constexpr std::uint32_t MoveDirection = 0x148;
	...
	constexpr std::uint32_t CurrentCamera = 0x418;
	constexpr std::uint32_t Health = 0x184;
	constexpr std::uint32_t MaxHealth = 0x1a4;
	constexpr std::uint32_t Name = 0x48;
	constexpr std::uint32_t CamPosFromEngine = 0xa0;
	constexpr std::uint32_t BaseValue = 0xc0;
	constexpr std::uint32_t CameraSubject = 0xc0;
	constexpr std::uint32_t Transparency = 0xd8;
	constexpr std::uint32_t CameraPosition = 0xf4;
	constexpr std::uint32_t CameraCFrame = 0xd0;
	constexpr std::uint32_t DisplayName = 0x100;
	constexpr std::uint32_t Brightness = 0x110;
	constexpr std::uint32_t FogEnd = 0x120;
	...
	constexpr std::uint32_t HumanoidJump = 0x180;
	constexpr std::uint32_t Color3 = 0x180;
	constexpr std::uint32_t HipHeight = 0x190;
	constexpr std::uint32_t JumpPower = 0x1a0;
	constexpr std::uint32_t HumanoidRigType = 0x1b8;
	constexpr std::uint32_t WalkSpeedA = 0x1c0;
	constexpr std::uint32_t Team = 0x1d0;
	constexpr std::uint32_t UserId = 0x1e0;
	constexpr std::uint32_t CameraMaxZoomDistance = 0x238;
	constexpr std::uint32_t CameraMinZoomDistance = 0x23c;
	constexpr std::uint32_t CameraMode = 0x240;
	constexpr std::uint32_t MeshId = 0x250;
	...
	constexpr std::uint32_t TextLabelText = 0x6a0;
